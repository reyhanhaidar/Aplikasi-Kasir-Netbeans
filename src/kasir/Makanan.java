...
public class Makanan extends javax.swing.JFrame {
    ...
    private void simpan(){
     try {
            String sql="insert into barang (Kode_Makanan,Nama_Makanan,Stok,Harga) value (?,?,?,?,?)";
            pst=koneksi.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        jLabelCekStok = new javax.swing.JLabel();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(27, 27, 27)
                .addComponent(jLabelCek, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jLabel1.setText("Input Data Makanan");
    ...
    rst=pst.executeQuery();
    if (rst.next()) {
    String data1=rst.getString(("Kode_Makanan"));
    jTextField2.setText(data1);
    String data2=rst.getString(("Nama_Makanan"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
         ...
         String sql="update barang set Nama_Makanan='"+value1+"' ,Stok='"+value3+"' ,Harga='"+value5+"' where Kode_Makanan='"+value2+"'";
         pst=koneksi.prepareStatement(sql);
         pst.execute();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try { 
    String sql="delete from barang where Kode_Makanan=?";
    pst=koneksi.prepareStatement(sql);
    pst.setString(1, jTextField2.getText());
    pst.execute();
    ...
    private javax.swing.JLabel jLabelCekStok;
